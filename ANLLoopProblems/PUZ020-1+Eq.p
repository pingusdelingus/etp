%--------------------------------------------------------------------------
% File     : PUZ020-1 : TPTP v7.3.0. Released v1.0.0.
% Domain   : Puzzles
...
% Rating   : 0.00 v5.3.0, 0.06 v5.2.0, 0.00 v2.0.0
...
cnf(statement_by_substitution_1,axiom,
    ( A != B | statement_by(A) = statement_by(B) )).

cnf(a_truth_substitution_1,axiom,
    ( A != B | ~ a_truth(A) | a_truth(B) )).

cnf(knave_substitution_1,axiom,
    ( A != B | ~ knave(A) | knave(B) )).

cnf(knight_substitution_1,axiom,
    ( A != B | ~ knight(A) | knight(B) )).

cnf(person_substitution_1,axiom,
    ( A != B | ~ person(A) | person(B) )).

cnf(says_substitution_1,axiom,
    ( A != B | ~ says(A,C) | says(B,C) )).

cnf(says_substitution_2,axiom,
    ( A != B | ~ says(C,A) | says(C,B) )).
